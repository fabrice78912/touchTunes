...
public class JukeboxEventController {
    ...
    public Mono<ApiResponse<ActivationResponse>> activateJukebox(@RequestBody HardwareInfo hardwareInfo) {
        return jukeboxService.activateJukebox(hardwareInfo.serialNumber())
                .map(response -> ApiResponse.<ActivationResponse>builder()
