...
class PlayRequestServiceTest {
    ...
    private final PlayRequestService service = new PlayRequestService(
    ...
    void createPlayRequest_shouldReturnApiResponse_whenValidInput() {
        ...
        ApiResponse<Object> fakeProducerResponse = ApiResponse.builder()
        ...
        // Act
        ApiResponse<JukeboxEvent> response = playRequestService.createPlayRequest(
                userId,
                trackId,
                jukeboxId,
                EventType.PLAY_REQUEST_EVENT,
